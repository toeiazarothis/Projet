      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li><a href="#ajoutEleve" class="js-scrollTo">Suppresion d'élève</a></li>
            <li><a href="#ajoutProf" class="js-scrollTo">Suppresion de professeur</a></li>
            <li><a href="#ajoutPersonnelVS" class="js-scrollTo">Suppresion de membre du personnel</a></li>
            <li><a href="#ajoutClasse" class="js-scrollTo">Suppresion de classe</a></li>
          </ul>
